...
shady_vals <- Greenhouse$Performance[Greenhouse$Treatment == "Shady"]
sunny_vals <- Greenhouse$Performance[Greenhouse$Treatment == "Sunny"]

t.test(shady_vals, sunny_vals, paired = TRUE)
```
